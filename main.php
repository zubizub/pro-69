        ...
        <header id="header" class="header">
            <div class="header-column">
                <ul class="header-link__list">
                    ...
                    <li class="header-link__item call" style="<?=SITE_TEMPLATE_PATH?>/distr/www/font-family: 'Posterizer KG';"><a class="header-link" href="#">Перезвонить</a></li>
			...
			<div class="content-block">
				<div class="content-block__col_left">
					<div class="content__item block">
						<div class=""><img class="metro-place__img" src="<?=SITE_TEMPLATE_PATH?>/distr/www/f/media/slide7_1.jpg" alt="#"></div>
					</div>
