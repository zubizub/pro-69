        ...
        <div role="main" id="content" class="content">
			...
			<div class="content__item studios mobile flip-container">
				<div class="flipper">
                    ...
                    <div class="rel">
<svg version="1.1" id="svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" height="200px" viewBox="140 230 600 100" enable-background="new 0 0 850.39 481.89" xml:space="preserve" style="">
  <g>
    <path d="M251.162 331.447c-5.19-1.354-9.248-6.771-9.248-13.265c-0.457-23.83-2.937-45.491-7.897-69.042
	...
	c-0.447-1.626-0.677-3.521-1.127-5.417c-4.967 17.861-9.03 36.01-12.637 54.414C212.806 263.76 212.125 267.816 211.449 271.88" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M390.365 294.083c-16.695 3.791-33.396 8.938-49.41 15.703c-7.671 3.252-15.341 6.501-22.789 10.292h-0.224
	...
	c11.054-6.771 22.788-11.918 34.066-17.329c1.354-0.814 2.48-1.354 3.834-1.896L338.024 233.977z" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M505.2 175.5c-0.22 4.869-1.127 9.744-4.74 12.723c-0.896 0.812-2.253 1.354-3.38 1.626
	...
	c-9.024-1.084-18.048-2.979-26.845-6.229c3.607 4.061 9.474 5.959 14.891 6.229C409.77 193.903 413.83 193.903 417.887 193.64" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M575.359 248.599c-2.026-0.542-4.054-0.814-6.084-1.354c0.45 3.249 1.127 6.492 1.577 9.472
	...
	c1.356-0.27 7.22-1.354 8.576-1.626h-4.739c-7.671 1.084-15.568 0.542-21.215-0.539C576.72 244.266 572.656 243.182 568.372 242.098" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M697.188 310.87c-2.479 4.063-5.181 7.854-8.344 11.097c-4.284 5.147-9.475 8.669-15.791 9.753
	...
	c-0.903-13.535-1.574-27.345-3.384-40.61c-0.67-4.054-1.127-8.118-1.804-11.912C676.66 197.967 675.307 193.092 673.733 188.493" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" />
  </g>
</svg>
